...
// } catch (err) {
//     console.error(err)
//     alert(err.response?.data?.message || 'Filed to delete book.');
//    }
// };
...
//             <p className={styles.listBooksTitle}>
...
//                             <select vlaue={filterCategory} onChange= {(e) => setFilterCategory(e.target.value)}
...
//                                         {book.image && (
//                                             <img src={`http://localhost:4000${book.image}`} alt={book.title} className='h-10 w-8 object-cover rounded' />
//                                         )}
//                                         <div className='ml-4'>
...
//                     </div><h3 className={styles.emptyTitle}>No books found</h3>
