...
//                   <Icon className={styles.statsIcon(stat.iconColor)} />
//                 </div>
//               </div>
//             </div>
//           ))}
...
//               </div>
//               <input type='text' placeholder='Search orders, customers, or books...' value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}
...
//                     <div className={styles.lengthDot(i.color)}></div>
...
//                 <img src={`${API_BASE}${bk.image}`} alt={bk.title} className='w-16 h-20 object-cover rounded' />
          ...
          <div className={styles.modalSection}>
             ...
             <div className={styles.sectionContent}> 
               {[
                ...
                <div key={i} className={styles.paymentInfoItem}>
                  <span className={styles.paymentLabel}>{it.label}</span>
                  <span className={styles.paymentBadgeModal(it.color)}>{it.value}
                  </span>
                </div>
              ))}
            </div>
