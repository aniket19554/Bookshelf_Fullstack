...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => setScrolled(window.scroll > 10)
                ...
                <div className='flex flex-col space-y-1'>
                    {navItems.map((item) => {
                        ...
                        return (
                            ...
                            className={navbarStyles.mabileNavItem(isActive, item.color)}>
                                <item.icon className={navbarStyles.mobileNavIcon(isActive, item.color)} />
                                <span className={navbarStyles.mobileNavIcon.Text(isActive, item.color)}>
                                    {item.name}
                                </span>
                            </Link>
                        )
