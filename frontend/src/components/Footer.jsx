  ...
  return (
    <footer className={styles.footer}>
        ...
        <div className={styles.contactBlock}>
            ...
            <div className={styles.contactList}>
                <div className={styles.contactItem}>
                    ...
                    <span>+91 7567259164</span>
                </div>

                <div className={styles.contactRow}>
                    <Mail className={styles.contactIconInline} />
                    <span>contact2bookshell.com</span>
                </div>
            </div>
        </div>
        </div>
        ...
        <div className={styles.copyrightWrap}>
            ...
            <a href="https://www.hexagondigitalservices.com/" target='_blank' className='text-sm cursor-pointer text-gray-500 hover:text-purple-600'>
                Powered By {" "} <br />
