                    ...
                    <form onSubmit={handleSearch} className='space-y-6 md:space-y-8'>
                        <div className={formContainer}>
                            <div className={inputWrapper}>
                                <div className='absolute insert-0 bg-white/90 rounded-lg md:rounded-xl shadow-sm' />
            ...
            {/* FOOTER TEXTS */}
                        <div className={scrollTextSection}>
                            <div className={scrollText}>
                                Currated Collections • Award-Wining Authors • Critical Analysis • Cultural Perspective
                            </div>
                        </div>
        </div>
    </div>
